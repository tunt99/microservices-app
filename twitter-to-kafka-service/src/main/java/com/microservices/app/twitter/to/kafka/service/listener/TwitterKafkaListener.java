...
import com.microservices.app.common.util.FunctionUtils;
...
public class TwitterKafkaListener extends StatusAdapter {
    ...
    public void onStatus(Status status) {
        ...
        kafkaProducer.send(kafkaConfigData.getTopicName(), String.valueOf(twitterAvroModel.getId()), functionUtils.parseString(twitterAvroModel));
    }
}
