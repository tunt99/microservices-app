...
public class TwitterAnalyticsAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public TwitterAnalyticsAvroModel(String word, Long wordCount, Long createdAt) {
    this.word = word;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
      case 0 -> word = value$ != null ? value$.toString() : null;
      case 1 -> wordCount = (Long) value$;
      case 2 -> createdAt = (Long) value$;
      default -> throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  @AvroGenerated
  public static class Builder extends SpecificRecordBuilderBase<TwitterAnalyticsAvroModel>
    implements RecordBuilder<TwitterAnalyticsAvroModel> {
    ...
    /**
      ...
      * @return This builder.
      */
    public TwitterAnalyticsAvroModel.Builder setWord(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public TwitterAnalyticsAvroModel.Builder setWordCount(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public TwitterAnalyticsAvroModel.Builder setCreatedAt(Long value) {
    ...
    public TwitterAnalyticsAvroModel build() {
      try {
        ...
        record.wordCount = fieldSetFlags()[1] ? this.wordCount : (Long) defaultValue(fields()[1]);
        record.createdAt = fieldSetFlags()[2] ? this.createdAt : (Long) defaultValue(fields()[2]);
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final DatumWriter<TwitterAnalyticsAvroModel>
    WRITER$ = (DatumWriter<TwitterAnalyticsAvroModel>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final DatumReader<TwitterAnalyticsAvroModel>
    READER$ = (DatumReader<TwitterAnalyticsAvroModel>)MODEL$.createDatumReader(SCHEMA$);
